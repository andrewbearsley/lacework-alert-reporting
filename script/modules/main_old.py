...
def main():
    ...
    print("-"*80)
    print("\033[1;36mStep 1: Loading API credentials\033[0m")
    credentials = load_api_credentials(args.api_key_file)
    
    # Initialize components
    print("-"*80)
    print("\033[1;36mStep 2: Initializing Lacework client\033[0m")
    ...
    print("-"*80)
    print("\033[1;36mStep 3: Retrieving compliance alerts\033[0m")
    ...
    print("-"*80)
    print("\033[1;36mStep 4: Processing alert details\033[0m")
    ...
    # Get policy details
    print("-"*80)
    print("\033[1;36mStep 5: Retrieving policy details\033[0m")
    ...
    print("-"*80)
    print("\033[1;36mStep 6: Enriching alerts with policy details\033[0m")
    ...
    if args.aws_account:
        print(f"\nFiltering alerts for AWS account {args.aws_account}...")
    ...
    # Print alert summary (disabled - too verbose)
    ...
    if enriched_alerts and not args.no_tags:
        print("-"*80)
        print("\033[1;36mStep 6.5: Retrieving resource tags for alerts\033[0m")
    ...
    if not args.skip_compliance:
        print("-"*80)
        print("\033[1;36mStep 7: Retrieving compliance status\033[0m")
    ...
    if compliance_data and not args.no_tags:
        print("-"*80)
        print("\033[1;36mStep 8: Retrieving resource tags for compliance data\033[0m")
    ...
    print("-"*80)
    print("\033[1;36mStep 9: Writing Excel output\033[0m")
